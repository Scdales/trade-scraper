...
class Redis:
    ...
    # Pass in the custom function to the subscribe method. Receives (redis: Redis, epic: string)
    async def subscribe(self, custom_function):
                        ...
                        if message is not None:
                            if message["data"] == STOPWORD:
                                ...
                                try:
                                    ...
                                    thread = Thread(target=custom_function(self, epic))
                                    thread.start()
